...
namespace MadApper.Input
{
    ...
    public class GestureController : MonoBehaviour
    {
        ...
        InputManagerSettingsSO settings;

        public void Setup(InputManagerSettingsSO settings)
        {
            this.settings = settings;

            inputManager.Setup(settings);
        ...
        public PointerInputManager GetInputManager() => inputManager;
        ...
        {            
            if (activeGestures.ContainsKey(input.InputId))            
                return;          
        ...
        public Vector2 GetPointerPosition() => inputManager.GetPointerPosition();
