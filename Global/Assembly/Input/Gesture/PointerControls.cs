...
//     version 1.14.0
//     from Assets/_MadApperEssentials/Global/Assembly/Input/Gesture/PointerControls.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/_MadApperEssentials/Global/Assembly/Input/Gesture/PointerControls.inputactions".
/// </summary>
/// <remarks>
...
public partial class @PointerControls: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""scroll"",
                    ""type"": ""Value"",
                    ""id"": ""88ffbc6c-af21-4920-9b62-d9ead5bd6168"",
                ...
                },
                {
                    ""name"": ""Touch0Vector"",
                    ""type"": ""Value"",
                    ""id"": ""c2bb49a7-50b0-4e8e-94f6-cc90a2e4cb01"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
                },
                {
                    ""name"": ""Touch1Vector"",
                    ""type"": ""Value"",
                    ""id"": ""4ed930f6-d43e-41c7-ac2e-c98d9bffbeaa"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
                },
                {
                    ...
                    ""type"": ""Button"",
                    ""id"": ""1a9a5e9e-a756-4dbe-a786-6cdfc35675a8"",
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""3a25bde5-12eb-4399-8f36-194dddcce88c"",
                    ""path"": ""<Mouse>/scroll"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""c5239354-cbf6-4a0f-865f-98f40cb0a02b"",
                ...
                {
                    ""name"": """",
                    ""id"": ""313633cf-4136-419c-a79a-0256acda0783"",
                    ""path"": ""<Touchscreen>/touch1/press"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Touch"",
                ...
                {
                    ""name"": """",
                    ""id"": ""ad087976-7707-46e0-8b3d-6f560b5b6299"",
                    ""path"": ""<Touchscreen>/touch1/position"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Touch"",
    ...
    ""controlSchemes"": [
        ...
        m_pointer_Touch0Vector = m_pointer.FindAction("Touch0Vector", throwIfNotFound: true);
        m_pointer_Touch1Vector = m_pointer.FindAction("Touch1Vector", throwIfNotFound: true);
        m_pointer_SecondTouchContact = m_pointer.FindAction("SecondTouchContact", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_pointer_Touch0Vector;
    private readonly InputAction m_pointer_Touch1Vector;
    private readonly InputAction m_pointer_SecondTouchContact;
    /// <summary>
    ...
    public struct PointerActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "pointer/scroll".
        /// </summary>
        public InputAction @scroll => m_Wrapper.m_pointer_scroll;
        /// <summary>
        /// Provides access to the underlying input action "pointer/Touch0Vector".
        /// </summary>
        public InputAction @Touch0Vector => m_Wrapper.m_pointer_Touch0Vector;
        /// <summary>
        /// Provides access to the underlying input action "pointer/Touch1Vector".
        /// </summary>
        public InputAction @Touch1Vector => m_Wrapper.m_pointer_Touch1Vector;
        /// <summary>
        /// Provides access to the underlying input action "pointer/SecondTouchContact".
        /// </summary>
        public InputAction @SecondTouchContact => m_Wrapper.m_pointer_SecondTouchContact;
        /// <summary>
        ...
        public void AddCallbacks(IPointerActions instance)
        {
            ...
            @Touch0Vector.started += instance.OnTouch0Vector;
            @Touch0Vector.performed += instance.OnTouch0Vector;
            @Touch0Vector.canceled += instance.OnTouch0Vector;
            @Touch1Vector.started += instance.OnTouch1Vector;
            @Touch1Vector.performed += instance.OnTouch1Vector;
            @Touch1Vector.canceled += instance.OnTouch1Vector;
    ...
    public interface IPointerActions
    {
        ...
        /// <summary>
        /// Method invoked when associated input action "Touch0Vector" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnTouch0Vector(InputAction.CallbackContext context);
        /// <summary>
        /// Method invoked when associated input action "Touch1Vector" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnTouch1Vector(InputAction.CallbackContext context);
        /// <summary>
